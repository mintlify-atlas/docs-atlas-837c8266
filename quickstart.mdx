...
try {
  ...
  if (err instanceof z.core.$ZodRealError) {
...
<CardGroup cols={2}>
  <Card title="Primitives" icon="shapes" href="/primitives">
    Explore all primitive types: strings, numbers, dates, and more
  </Card>
  <Card title="Objects" icon="cubes" href="/objects">
    Learn about object schemas, nesting, and composition
  </Card>
  <Card title="Arrays & Tuples" icon="list" href="/arrays">
    Work with arrays, tuples, and collections
  </Card>
  <Card title="Advanced Types" icon="wand-magic-sparkles" href="/unions">
